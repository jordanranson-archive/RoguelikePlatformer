ig.module(
    ...
    .defines(function () {
        ...
        ig.EntityPlayer = ig.global.EntityPlayer = ig.Player.extend({
            ...
            realJumpSteps: _c.CHARACTER.JUMP_STEPS,
            realSize: _c.CHARACTER.SIZE_EFFECTIVE_Y,
            realFriction: _c.CHARACTER.FRICTION_GROUNDED_X,
            ...
            handleInput: function () {
                ...
                // Crouching
                if (ig.input.pressed('down') && this.grounded) {
                ...
                // End crouching
                if (ig.input.released('down') && this._crouching) {
                    var offset = this.realSize - this.sizeCrouching;
                ...
                //console.log( this.vel.x, this.maxVel.x );
            },
            ...
            jump: function () {
                ...
                var min = 9, max = 40;
                var steps = this.jumpLength.limit(min,max);
                this.jumpSteps = steps.map(min,max,this.realJumpSteps-1,this.realJumpSteps*2);
            ...
            doubleJump: function() {
                ...
                // Double jump
                if (!this.grounded && this.jumping && !this._doubleJumping) {
                    this.jumpTimer.reset();

                    this.jumpSteps = this.realJumpSteps-1;
                ...
                // Triple jump
                if (!this.grounded && this.jumping && this._doubleJumping && !this._tripleJumping && this.jumpTimer.delta() > 0.2) {
