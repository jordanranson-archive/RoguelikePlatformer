ig.module(
    ...
    .defines(function () {
        ...
        ig.EntityPiston = ig.global.EntityPiston = ig.EntityExtended.extend({
            ...
            canSetPoundInterval: function( entity ) {
                if( entity.poundInterval ) {
                    this.poundInterval = entity.poundInterval;
                    return true;
                } else {
                    return false;
                }
