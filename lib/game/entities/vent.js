    ...
    .defines(function () {
        ...
        ig.EntityVent = ig.global.EntityVent = ig.EntityTrigger.extend({
            ...
            update: function() {
                ...
                // Fire
                if( this.firing ) {
                    if( this.spawnerTarget && this.spawnerTarget !== null ) {
                        var entity = ig.game.getEntityByName(this.spawnerTarget);
                    ...
                    if( this.spawnerTarget && this.spawnerTarget !== null ) {
                        var entity = ig.game.getEntityByName(this.spawnerTarget);
                        entity.spawning = entity._spawningComplete = entity._reactivate = false;
                        entity.spawnedCount = entity.spawnTargetSequence.length = entity._spawnedAtTargetIndex = 0;
                    }
                }
            },

            vent: function( entity ) {
                //console.log('venting at '+entity.name+'!');
            }
